    ...
    <loginContext.Provider value={{ token, setToken }}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={isAuth ? <Navigate to="add" /> : <Navigate to="login" />} />
          <Route path="login" element={isAuth ? <Navigate to="/add" /> : <Login />} />
          <Route path="list" element={isAuth ? <List /> : <Navigate to="/login"/>} />
          <Route path="add" element={isAuth ? <AddForm /> : <Navigate to="/login"/>} />
        </Routes>
      </BrowserRouter>
